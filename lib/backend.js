...
var Backend = (function() {
  ...
  Backend.prototype.preMove = function(socket, data) {
    ...
    this.emit('app.game.player.preMoved', {gameId: game.id, socketId: socket.id, stateMatrix: stateMatrix, word: word});
  };
  ...
  var events = {
    ...
    onPlayerPreMoved: function(data) {
      ...
      if (playerType) {
        this.broadcastToGamePlayers(data.gameId, playerType, {action: 'playerPreMoved', game: publicGame, word: data.word, stateMatrix: data.stateMatrix});
      }
    },
